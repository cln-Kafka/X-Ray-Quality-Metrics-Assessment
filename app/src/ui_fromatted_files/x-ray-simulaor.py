...
class Ui_XRaySimulator_Ui(object):
    def setupUi(self, XRaySimulator_Ui):
        XRaySimulator_Ui.setObjectName("XRaySimulator_Ui")
        XRaySimulator_Ui.resize(618, 878)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed
        )
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(XRaySimulator_Ui.sizePolicy().hasHeightForWidth())
        XRaySimulator_Ui.setSizePolicy(sizePolicy)
        XRaySimulator_Ui.setMinimumSize(QtCore.QSize(618, 878))
        XRaySimulator_Ui.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.centralwidget = QtWidgets.QWidget(parent=XRaySimulator_Ui)
        ...
        self.mAs_label_2 = QtWidgets.QLabel(parent=self.image_simulator_groupBox)
        self.mAs_label_2.setObjectName("mAs_label_2")
        self.image_simulator_groupbox_gridlayout.addWidget(self.mAs_label_2, 2, 0, 1, 1)
        ...
        self.horizontalSlider = QtWidgets.QSlider(parent=self.image_simulator_groupBox)
        self.horizontalSlider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.image_simulator_groupbox_gridlayout.addWidget(
            self.horizontalSlider, 0, 1, 1, 1
        )
        ...
        self.image_simulator_groupbox_gridlayout.addWidget(
            self.horizontalSlider_2, 1, 1, 1, 1
        )
        ...
        self.image_simulator_groupbox_gridlayout.addWidget(
            self.horizontalSlider_3, 2, 1, 1, 1
        )
        ...
        self.simulate_parameters_btn.setObjectName("simulate_parameters_btn")
        ...
        XRaySimulator_Ui.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(parent=XRaySimulator_Ui)
        ...
        XRaySimulator_Ui.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=XRaySimulator_Ui)
        self.statusbar.setObjectName("statusbar")
        XRaySimulator_Ui.setStatusBar(self.statusbar)
        self.toolBar = QtWidgets.QToolBar(parent=XRaySimulator_Ui)
        self.toolBar.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly)
        self.toolBar.setObjectName("toolBar")
        XRaySimulator_Ui.addToolBar(QtCore.Qt.ToolBarArea.TopToolBarArea, self.toolBar)
        self.actionRectangle_ROI = QtGui.QAction(parent=XRaySimulator_Ui)
        self.actionRectangle_ROI.setCheckable(True)
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap(":/Icons/testing_environment/assets/icons/rectangle_roi.png"),
        ...
        self.actionImport_Image = QtGui.QAction(parent=XRaySimulator_Ui)
        self.actionImport_Image.setObjectName("actionImport_Image")
        self.actionExit = QtGui.QAction(parent=XRaySimulator_Ui)
        self.actionExit.setObjectName("actionExit")
        self.actionDocumentation = QtGui.QAction(parent=XRaySimulator_Ui)
        self.actionDocumentation.setObjectName("actionDocumentation")
        self.actionReset = QtGui.QAction(parent=XRaySimulator_Ui)
        self.actionReset.setEnabled(False)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap(":/Icons/testing_environment/assets/icons/reset.png"),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        ...
        self.retranslateUi(XRaySimulator_Ui)
        QtCore.QMetaObject.connectSlotsByName(XRaySimulator_Ui)
    ...
    def retranslateUi(self, XRaySimulator_Ui):
        ...
        self.mAs_label_2.setText(_translate("XRaySimulator_Ui", "Contrast"))
        self.kVp_label.setText(_translate("XRaySimulator_Ui", "Noise"))
        self.mAs_label.setText(_translate("XRaySimulator_Ui", "Blur"))
        self.simulate_parameters_btn.setText(
            _translate("XRaySimulator_Ui", "Simulate parameters")
        )
        ...
        self.cnr_value_label.setText(_translate("XRaySimulator_Ui", "0"))
        self.snr_label.setText(_translate("XRaySimulator_Ui", "SNR"))
        self.snr_value_label.setText(_translate("XRaySimulator_Ui", "0"))
        self.spatial_resolution_label.setText(
            _translate("XRaySimulator_Ui", "Spatial Resolution")
        )
        self.spatial_resolution_value_label.setText(_translate("XRaySimulator_Ui", "0"))
...
if __name__ == "__main__":
    ...
    XRaySimulator_Ui = QtWidgets.QMainWindow()
    ui = Ui_XRaySimulator_Ui()
    ui.setupUi(XRaySimulator_Ui)
    XRaySimulator_Ui.show()
    sys.exit(app.exec())
